...
header:
  overlay_image: /assets/images/strategy_header.png
  overlay_filter: 0.3
---
...
This Streamlit app helps simulate and optimize combinations of strategic initiatives based on cost, engineering effort, and ARR impact. It allows for both manual selection and automated optimization using a knapsack model, while also visualizing ROI risk through Monte Carlo simulations.
</p>
...
<ul style="font-size: 15px; line-height: 1.7;">
  ...
  <li><strong>Maximize ROI:</strong> total ARR impact minus cost</li>
...
<img src="/assets/video/strategy_simulator.gif" alt="Strategy Simulator Demo" style="width: 85%; border-radius: 8px; margin: 20px 0;"/>
